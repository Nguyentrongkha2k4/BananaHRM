...
var AuthOperation = /** @class */ (function () {
    function AuthOperation() {
        this.baseUrl = 'https://co3001-software-engineering-backend-hk241-m8e7.onrender.com/api/v1/internal/admin';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post("https://co3001-software-engineering-backend-hk241-m8e7.onrender.com/api/v1/payments/create?a4Count=".concat(a4Count, "&a3Count=").concat(a3Count), {}, {
                                withCredentials: true,
                                validateStatus: function (status) { return status >= 200 && status <= 500; },
                                headers: {
                                    Authorization: "Bearer ".concat(token),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("https://co3001-software-engineering-backend-hk241-m8e7.onrender.com/api/v1/payments", {
                                withCredentials: true,
                                validateStatus: function (status) { return status >= 200 && status <= 500; },
                                headers: {
                                    Authorization: "Bearer ".concat(token),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post("https://co3001-software-engineering-backend-hk241-m8e7.onrender.com/api/v1/momo/ipn", payload, {
                                withCredentials: true,
                                validateStatus: function (status) { return status >= 200 && status <= 500; },
                                headers: {
                                    Authorization: "Bearer ".concat(token)
